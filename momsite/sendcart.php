/*source: https://github.com/wojodesign/simplecart-js/issues/323*/
<?php
$to = 'order@myshop.com';
$subject = 'Circles-of-Life: Simple Cart Order';
$content = $_POST;
$email_message = ''; $firstname = 'first_name'; $lastname = 'last_name';
$email_from = 'email'; $phone = 'phone'; $comments = 'comments';
...
$headers = 'From: webmaster@circles-of-life.com'."\r\n". 'Reply-To: webmaster@circles-of-life.com' . "\r\n" . 'X-Mailer: PHP/' . phpversion(); 
mail($to, $subject, $body, $email_message, $headers); Header('Location: success.html'); ?> 